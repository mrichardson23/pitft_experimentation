...
while (refreshNeeded):
	...
	d.text((10,5), "Option A", font=fnt, fill=(255,255,255,255))
	d.text((10,95), "Option B", font=fnt, fill=(255,255,255,255))
	d.text((10,185), "Option C", font=fnt, fill=(255,255,255,255))
	if (local_ip_address == "No IP"):
		try:
			...
			local_ip_address = "No IP"
	d.text((10,275), local_ip_address, font=fnt, fill=(255,255,255,255))
